                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-material" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" class="form-control form-control-line" name="brand_name" value="">
                                    @error('brand_name')
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <textarea rows="5" class="form-control form-control-line"  name="brand_des"></textarea>
                                    @error('brand_des')
                                    <span style="color: red">{{ $message }}</span>
                                    @enderror
                                </div>
