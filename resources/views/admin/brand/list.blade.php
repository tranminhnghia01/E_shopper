        ...
        <div class="row">
            <div class="col-12">
                                ...
                                <tbody>
                                    @foreach ($list as $value )
                                        <tr>
                                            ...
                                            <td>{{ $value->brand_des }}</td>
                                            <td>
                                                <a href="{{ route('admin.brand-edit',$value->id) }}">Edit</a><br/>
                                                <a href="{{ route('admin.brand-delete',$value->id) }}">Delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                ...
                <div class="form-group">
                    <div class="col-sm-12">
                        <a href="{{ route('admin.brand-add') }}" class="btn btn-success">Add Blog</a>
                    </div>
                </div>
            </div>
        </div>
