    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-xlg-3 col-md-5">
                <div class="card">
                    <div class="card-body">
                        <center class="m-t-30"> <img src="{{ asset('admin/upload/user/avatar/'.$user->avatar) }}" class="rounded-circle" width="150" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <select class="form-control form-control-line" name="id_country">
                                        {{-- <option  value="{{  $user->id_country }}">London</option> --}}
                                        @foreach ($country as $key )
                                        @if ($key->id == $user->id_country)
                                            <option  value="{{  $key->id }}" selected>{{ $key->country_name }}</option>
                                        @else
